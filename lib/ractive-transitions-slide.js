...
(function ( global, factory ) {
	...
	slide = function ( t, params ) {
		...
		if ( t.isIntro ) {
			...
			t.setStyle('backgroundColor', 'yellow');
...
//			console.log("plm", targetStyle['backgroundColor'])
			t.animateStyle( 'backgroundColor', targetStyle['backgroundColor'] || '' , {duration:600} ).then(
				t.complete
			)
		}

		t.animateStyle( targetStyle, params ).then(
			animateBackground
		);
